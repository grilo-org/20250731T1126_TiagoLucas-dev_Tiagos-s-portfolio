    ...
    <header className="flex flex-1 flex-col sticky top-0 z-10 bg-white dark:bg-neutral-800 border-b border-gray-200 p-4 -mx-10 px-10 ">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            {menuOpen ? (
              <X size={32} className="dark:fill-white" />
            ) : (
              <List size={32} className="dark:fill-white" />
            )}
          </button>
        </div>
      </div>
        ...
        <nav className="mt-4">
          <ul className="flex flex-col gap-4 font-semibold dark:text-white">
            <li className="hoverable">
              <Link href="#sobre-mim" onClick={() => setMenuOpen(false)}>Sobre mim</Link>
            </li>
            <li className="hoverable">
              <Link href="#ultimos-projetos" onClick={() => setMenuOpen(false)}>Últimos projetos</Link>
            </li>
            <li className="hoverable">
              <Link href="#experiencia" onClick={() => setMenuOpen(false)}>Experiência</Link>
            </li>
            <li className="hoverable">
