            ...
            {projects.map((project, index) => (
                <div key={index} className="pb-8 flex flex-col items-center border-2 rounded-lg overflow-hidden max-w-[31.25rem] ">
                        <a href={project.link} target="_blank">
                            <Image src={project.imageSrc} alt={project.alt} width={500} height={500} className="rounded-t-md hoverable hover:scale-[1.1] brightness-125 transition duration-[2s] ease-in-out hover:saturate-[1.2]" />
                        </a>
